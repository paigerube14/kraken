...
Usage:
    python tests/test_virt_checker.py
...
class TestVirtChecker(unittest.TestCase):
    ...
    def test_check_disconnected_access_with_new_node(self, mock_invoke, mock_plugin_class, mock_yaml):
        ...
        mock_invoke.side_effect = ["some output", "False", "False", "True"]
    ...
    def test_check_disconnected_access_with_ssh_node_fallback(self, mock_invoke, mock_plugin_class, mock_yaml):
        ...
        # Mock failed attempts on original node and new node, successful on ssh_node
        mock_invoke.side_effect = ["some output", "False", "False", "False", "True"]
...
def run_tests():
    ...
    suite = loader.loadTestsFromTestCase(TestVirtChecker)
