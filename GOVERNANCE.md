...
### Member
Members are active contributors to the community. Anyone can become a member by participating in discussions, reporting bugs, or contributing code or documentation.
...
### Reviewer
Reviewers are trusted members of the community who have demonstrated a strong understanding of the project's codebase and conventions.
...
### Approver
Approvers are experienced reviewers who have the authority to approve pull requests for merging.

#### Responsibilities:

Approve pull requests that have been thoroughly reviewed and meet the project's quality standards.

Ensure that the CI/CD pipeline passes before approving a merge.
